...
write.xlsx(round(sur.20.20.cor,4), 'sur.20.20.cor.xlsx')

sur.20.5.cor = cov2cor(fitsur.20.5$residCov)

write.xlsx(round(sur.20.5.cor,4), 'sur.20.5.cor.xlsx')

sur.Gini.cor = cov2cor(fitsur.Gini$residCov)

write.xlsx(round(sur.Gini.cor,4), 'sur.Gini.cor.xlsx')

#Owner.Percent export
owners = list(full.20.20.owner.reg, full.20.5.owner.reg, full.Gini.owner.reg)
...
stargazer(owners, dep.var.caption = 'Dependent Variable is Percentage of the Population Who Are Homeowners', title = 'Ownership Robustness Check',
          ...
          out = 'Homeownership.robustnesscheck.txt')
